...
namespace Jogador_Inimigo
{
    ...
    public class Jogador
    {
        ...
        //Método Construct
        public Jogador(string defineNome, int defineForca, int defineAtaque, int defineDefesa, int defineVelocidade, float defineDinheiro)
        {
            //this. apenas para saber variável
