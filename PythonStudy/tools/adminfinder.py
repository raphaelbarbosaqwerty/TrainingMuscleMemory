...
################
	''')
print ("Usage ex: http://localhlost/\n")
print ("Insert http://\n")

#site
url = input("Website enter: ")
print("Starting: ")
time.sleep(1)
#admin pages
pages = ('admin/','administrator/','phpmyadmin/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for page in pages :
	...
	try:
		...
		#if find admin page print msg && link
		print(CGREEN + "[+]page foud: "+curl)
	#if find and error
	except urllib.error.URLError as msg:
		print(CRED + "[-]Not found: "+curl);
print("\n")
